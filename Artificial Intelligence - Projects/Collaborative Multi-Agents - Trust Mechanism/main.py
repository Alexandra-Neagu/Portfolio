...
if __name__ == "__main__":
    ...
    if choice1=='tutorial':
        ...
        if choice3=='normal' or choice3=='strong' or choice3=='weak':
            # for evaluation
            print("\nEnter the evaluation type 'ALWAYS-TRUST','NEVER-TRUST', 'RANDOM-TRUST', or press enter to skip:")
            choice4=input()
            if choice4=='ALWAYS-TRUST' or choice4=='NEVER-TRUST' or choice4=='RANDOM-TRUST':
                builder = create_builder(task_type=choice1, condition=choice3, name=choice2, folder=fld, eval_type=choice4)
            else:
