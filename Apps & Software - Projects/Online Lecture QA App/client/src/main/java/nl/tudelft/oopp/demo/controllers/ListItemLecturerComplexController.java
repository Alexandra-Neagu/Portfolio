 ...
 */
public class ListItemLecturerComplexController implements Initializable {
    ...
    public void handleResponseBtn() {
        ...
        if (content == null || content.length() < 1) {
            ...
            answer.setLecturerId(MainApp.getCurrentUser().getId());
    ...
    public void handleReviewBtn() throws IOException {
        ...
        LecturerMainPageController.timeline.stop();
    }
